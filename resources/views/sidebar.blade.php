...
<aside class="sidebar">
    <div class="sidebar-header">
        <a href="{{ route('home') }}" class="sidebar-logo">CodeCraft AI</a>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-submenu">
                <li>
                    <a href="{{ route('chat.clear') }}" class="nav-link active">
                        <!-- Chat Icon SVG -->
    ...
    <div class="sidebar-footer">
        <p class="footer-note">CodeCraft AI models may make mistakes, so double-check outputs.</p>
        <a href="#" class="nav-link">
             <!-- Settings Icon -->
